...
More instructions are provided in the corresponding modules.
...
- [__tickers.csv__](https://github.com/linvieson/llm_financial_portfolio_construction/blob/main/tickers.csv): data on the tickers of the companies and the sectors to which these companies belong (by GICS).
...
The result of the research is the answered question: Can LLMs construct financial portfolios to outperform the benchmarks? The answer is yes, with the consideration that:

1. the LLM portfolios need further optimisation in some cases;
2. the LLMs are a tool in a bigger process of financial portfolio construction rather than a replacement to current techniques.

When combined with the classic methods and algorithms, LLMs can serve a useful purpose and be good assistants when it comes to the tasks in finances, specifically in financial portfolio construction.


## Demonstration

The video with the demonstration of work of the code can be found by following the [__link__](https://youtu.be/0sU8yP0eR_s) (YouTube video).
